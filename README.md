...
- **Pay-per-use API endpoints** on Monad Mainnet and Monad Testnet
...
- `NEXT_PUBLIC_SITE_URL` - Monad URL of the server (used by the web app)
- `FACILITATOR_URL` - URL of the x402 facilitator service (e.g. `https://makustudio.org/facilitator`)
...
- `MONAD_RPC_URL` - Monad Mainnet RPC URL (https)
- `MONAD_SEPOLIA_RPC_URL` - Monad Testnet RPC URL (https)
